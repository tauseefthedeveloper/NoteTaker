...
<body class="bg-gray-100">
	...
	<div class="container-100">
		...
		<div class="flex items-center justify-center bg-gray-100"
			style="height: 90vh;">
			<form action="UpdateNote" method="post" id="UpdateForm"
				class="bg-white p-8 rounded-2xl shadow-lg w-full max-w-md">
				<h2 class="text-2xl font-semibold text-gray-700 mb-2">Edit the
					note</h2>
				...
				<div class="mb-4">
					...
					<textarea id="content" name="content" rows="3"
						class="w-full px-4 py-2 border rounded-lg focus:ring-2 focus:ring-blue-400 focus:outline-none"
						placeholder="Write your content..."><%=note.getContent()%></textarea>
				</div>
						...
						success:function(data){
							if(data.trim()=="true"){
								Swal.fire({
									...
									window.location.replace("allNotes.jsp");
								})
							}else{
								Swal.fire({
